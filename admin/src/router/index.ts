...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'distribution', name: 'Distribution', component: () => import('@/views/distribution/index.vue'), meta: { title: '分销管理' } },
      ...
      { path: 'content/knowledge', name: 'Knowledge', component: () => import('@/views/content/knowledge.vue'), meta: { title: '知识库' } },
      ...
      { path: 'content/universities', name: 'Universities', component: () => import('@/views/content/universities.vue'), meta: { title: '院校库' } },
      { path: 'content/majors', name: 'Majors', component: () => import('@/views/content/majors.vue'), meta: { title: '专业库' } },
