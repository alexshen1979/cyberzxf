...
export const api = {
  ...
  orders: {
    ...
    rechargeAnalytics: (params?: any) => http.get('/admin/orders/recharge-analytics', { params }),
    virtualSettlements: () => http.get('/admin/orders/virtual-settlements'),
  ...
  distribution: {
    ...
    generalAgents: () => http.get('/admin/distribution/general-agents'),
    ...
    generalAgentCommissions: (params?: any) => http.get('/admin/distribution/general-agent-commissions', { params }),
    generalAgentStats: (id: string) => http.get(`/admin/distribution/general-agents/${id}/stats`),
    updateGeneralAgentCommission: (id: string, data: any) => http.put(`/admin/distribution/general-agent-commissions/${id}`, data),
